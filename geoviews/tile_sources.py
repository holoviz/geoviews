...
# CartoDB basemaps
CartoDark = WMTS(
    "https://cartodb-basemaps-4.global.ssl.fastly.net/dark_all/{Z}/{X}/{Y}.png", name="CartoDark"
)
CartoEco = WMTS("http://3.api.cartocdn.com/base-eco/{Z}/{X}/{Y}.png", name="CartoEco")
CartoLight = WMTS(
    "https://cartodb-basemaps-4.global.ssl.fastly.net/light_all/{Z}/{X}/{Y}.png", name="CartoLight"
)
CartoMidnight = WMTS(
    "http://3.api.cartocdn.com/base-midnight/{Z}/{X}/{Y}.png", name="CartoMidnight"
)

# Stamen basemaps
StamenTerrain = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_terrain/{Z}/{X}/{Y}.png", name="StamenTerrain"
)
StamenTerrainRetina = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_terrain/{Z}/{X}/{Y}@2x.png",
    name="StamenTerrainRetina",
)
StamenWatercolor = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_watercolor/{Z}/{X}/{Y}.jpg", name="StamenWatercolor"
)
StamenToner = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_toner/{Z}/{X}/{Y}.png", name="StamenToner"
)
StamenTonerRetina = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_toner/{Z}/{X}/{Y}@2x.png", name="StamenTonerRetina"
)
StamenTonerBackground = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_toner_background/{Z}/{X}/{Y}.png",
    name="StamenTonerBackground",
)
StamenTonerBackgroundRetina = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_toner_background/{Z}/{X}/{Y}@2x.png",
    name="StamenTonerBackgroundRetina",
)
StamenLabels = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_toner_labels/{Z}/{X}/{Y}.png", name="StamenLabels"
)
StamenLabelsRetina = WMTS(
    "https://tiles.stadiamaps.com/tiles/stamen_toner_labels/{Z}/{X}/{Y}@2x.png",
    name="StamenLabelsRetina",
)
...
EsriOceanReference = WMTS(
    "https://server.arcgisonline.com/ArcGIS/rest/services/Ocean/World_Ocean_Reference/MapServer/tile/{Z}/{Y}/{X}",
    name="EsriOceanReference",
)
EsriWorldPhysical = WMTS(
    "https://server.arcgisonline.com/arcgis/rest/services/World_Physical_Map/MapServer/tile/{Z}/{Y}/{X}",
    name="EsriWorldPhysical",
)
EsriWorldShadedRelief = WMTS(
...
tile_sources = {
    k: v for k, v in locals().items() if isinstance(v, WMTS) and k != "ESRI" and "Stamen" not in k
}
